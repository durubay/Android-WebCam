...
public class BackgroundmJPEGService extends Service {
    public final String TAG = "WebCamJPEGService";
    ...
    public void onCreate() {
        ...
        SurfaceHolder.Callback callback = new SurfaceHolder.Callback() {
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(BackgroundmJPEGService.this);
                ...
                try {
                    ...
                    Toast.makeText(BackgroundmJPEGService.this, "Settings is broken", Toast.LENGTH_SHORT).show();
                ...
                if (mCamera == null) {
                    ...
                    Toast.makeText(BackgroundmJPEGService.this, getString(R.string.can_not_open_camera),
                ...
                try {
                    ...
                    Toast.makeText(BackgroundmJPEGService.this, "SurfaceHolder is not available",
                            Toast.LENGTH_SHORT).show();
                    stopSelf();
                ...
                try {
                    ...
                    Toast.makeText(BackgroundmJPEGService.this, message, Toast.LENGTH_SHORT).show();
                    stopSelf();
                }
                
                Toast.makeText(BackgroundmJPEGService.this, "Port: " + port, Toast.LENGTH_SHORT).show();
            }
